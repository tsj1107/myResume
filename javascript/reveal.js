 ...
 */
/*
 last modify by tangsj
 add overview button on controls
 2013.11.3
*/
...
var Reveal = (function(){
	...
	function setupDOM() {
		...
		if ( config.controls ) {
            ...
            dom.controlsView = toArray( document.querySelectorAll( '.navigate-view' ) );
		}
	...
	function addEventListeners() {
		...
		if ( config.controls && dom.controls ) {
			[ 'touchstart', 'click' ].forEach( function( eventName ) {
                ...
                dom.controlsView.forEach( function( el ) { el.addEventListener( eventName, onNavigateOverview, false ); } );
            } );
		}
	...
	function removeEventListeners() {
		...
		if ( config.controls && dom.controls ) {
			[ 'touchstart', 'click' ].forEach( function( eventName ) {
                ...
                dom.controlsView.forEach( function( el ) { el.removeEventListener( eventName, onNavigateOverview, false ); } );
			} );
		}
    ...
    function onNavigateOverview( event ) { event.preventDefault(); toggleOverview(); }
